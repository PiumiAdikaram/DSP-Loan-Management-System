...
function addAdmin($userName,$email,$conn){
    //require_once("connection.php");
    $sql = "INSERT INTO admin (userName,email,nic)
...
function addOfficer($userName,$email,$conn){
    //require_once("connection.php");
    $sql = "INSERT INTO officer (userName,email,nic)
    VALUES ('$userName','$email','$userName')";
...
function addCC($userName,$email,$conn){
    //require_once("connection.php");
    $sql = "INSERT INTO cashcollector (userName,email,nic)
    VALUES ('$userName','$email','$userName')";
...
function addManager($userName,$email,$conn){
    //require_once("connection.php");
    $sql = "INSERT INTO manager (userName,email,nic)
    VALUES ('$userName','$email','$userName')";
    ...
    <div class="loanform">
        <p class="chead"><i class="glyphicon glyphicon-usd"></i> Add New Loan<p>
            ...
            <form action="admin.php" method="POST" autocomplete="on" >
                ...
                Payment Method:<br> <input type="text" name="paymentMethods" class="form-control" placeholder="Enter Payment Method Ex:Monthly" required><br/>
